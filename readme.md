...
The network provides an auction mechanism for negotiation of matches, accounting of open interest from accepted matches, verification of physical delivery, and according settlement in the virtual.
